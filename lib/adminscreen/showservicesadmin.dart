...
import 'package:healmeup/adminscreen/searchresultpageadmin.dart';

import '../mainScreens/hospitals/hospital_details.dart';
import '../mainScreens/models/disease_list_data.dart';

class showServicesadmin extends StatelessWidget {
  @override
              ...
              child: Material(
                ...
                child: InkWell(
                  onTap: () {
                    Navigator.push(
                      context,
                      MaterialPageRoute(builder: (context) => SearchResultsPageAdmin(service: disease.titleTxt)),
                    );
                  },
                  child: Padding(
